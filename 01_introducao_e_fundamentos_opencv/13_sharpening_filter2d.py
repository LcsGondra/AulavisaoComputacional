"""
Exemplo 13 - Sharpening manual com cv2.filter2D.

O kernel destaca o pixel central e subtrai informações dos vizinhos,
reforçando transições rápidas de intensidade, como bordas e detalhes.
"""
...
def main() -> None:
    ...
    painel = cv2.hconcat([
        ...
        adicionar_titulo(redimensionar_quadrado(nitida, 420), "Kernel manual"),
    ])
    ...
    cv2.imshow("Sharpening manual", painel)
    while True:
